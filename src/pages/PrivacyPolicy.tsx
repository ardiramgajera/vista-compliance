            ...
            <div className="prose prose-invert max-w-none space-y-6 md:space-y-8 text-sm md:text-base text-left md:text-justify">
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground text-sm md:text-base text-left">
                  <li>The types of information we collect from you or that you may provide when you visit our website available at: <a href="https://compliancevista.com" target="_blank" rel="noopener noreferrer" style={{ color: '#37C643' }} className="hover:underline">compliancevista.com</a> ("our Website")</li>
