          ...
          <div className="flex flex-col items-start w-[30%]">
            ...
            <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
              <li className="flex items-start gap-2">
                ...
                <a href="https://compliancevista.com/" target="_blank" rel="noopener noreferrer" className="text-navy-foreground/80 hover:text-primary transition-colors duration-300">www.compliancevista.com</a>
              </li>
              <li className="flex items-start gap-2">
          ...
          <div className="flex flex-col items-start">
            ...
            <ul className="space-y-1.5 text-xs">
              <li className="flex items-start gap-1.5">
                ...
                <a href="https://compliancevista.com/" target="_blank" rel="noopener noreferrer" className="text-navy-foreground/80 hover:text-primary transition-colors duration-300 break-all">www.compliancevista.com</a>
              </li>
              <li className="flex items-start gap-1.5">
